...
| `MONGODB_URI` | MongoDB connection string | `mongodb://localhost:27017/request-db` |
...
| `SUPER_ADMIN_EMAIL` | Email for first admin user | - |
...
| Variable | Description | Default |
|----------|-------------|---------|
| `VITE_API_URL` | Backend API URL | `http://localhost:80/api` |
| `VITE_CLERK_PUBLISHABLE_KEY` | Clerk publishable key | - |

## API Documentation

> **Note:** All API endpoints have been tested and verified using Postman. Each endpoint returns appropriate success/error responses with proper HTTP status codes.
